  ...
  return (
    <>
      ...
      <div className="mx-auto w-full p-4 grid rowForm pt-0" style={{ top: 0 }}>
        ...
        <div className="inputForm">
          <label className="text-basic-gray text-base labelForm">
            <span className="text-smartPurple pr-1">*</span>Plantel de interés
          </label>
          <span className="iconInputForm">
        ...
        <div className="inputForm">
          <label className="text-basic-gray text-base labelForm">
            <span className="text-smartPurple pr-1">*</span>Programa de interés
          </label>
          <span className="iconInputForm">
      ...
      <div className="mx-auto w-full p-4 grid rowForm pt-0" style={{ top: 0 }}>
        ...
        <div className="inputForm">
          <label className="text-basic-gray text-base labelForm">
            <span className="text-smartPurple pr-1">*</span>Fecha de próximo
            contacto
          </label>
          <span className="iconInputForm">
            <img className="mx-auto" src={calendario} width="30" />
        ...
        <div className="inputForm">
          <label className="text-basic-gray text-base labelForm">
            <span className="text-smartPurple pr-1">*</span>Fecha de último
            contacto
          </label>
          <span className="iconInputForm">
            <img className="mx-auto" src={calendario} width="30" />
        ...
        <div className="inputForm">
          <label className="text-basic-gray text-base labelForm">
            <span className="text-smartPurple pr-1">*</span>Última acción
            realizada
          </label>
          <span className="iconInputForm">
